...
The most popular libraries allow you to choose a consistent player design over a number of browsers and provide a fallback for browsers that don't support audio and video. Fallbacks often use Adobe Flash or Microsoft Silverlight plugins. Other functionality such as the track element
